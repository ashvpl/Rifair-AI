                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    >
                      ...
                      <div className="relative flex items-center overflow-hidden rounded-lg">
                        ...
                        <div 
                          ...
                          className="absolute right-3 cursor-pointer p-1 rounded-md hover:bg-white/10 transition-colors"
                        >
                          {showPassword ? (
                  ...
                  <div className="flex items-center justify-between pt-1">
                    <div className="flex items-center space-x-2">
                      <div className="relative cursor-pointer" onClick={() => setRememberMe(!rememberMe)}>
                        <div className={`h-4 w-4 rounded border transition-all duration-200 flex items-center justify-center ${
                          rememberMe ? 'bg-white border-white' : 'border-white/20 bg-white/5'
                        }`}>
                          {rememberMe && <Check className="w-3 h-3 text-black" strokeWidth={4} />}
                        </div>
                      </div>
                      <span className="text-xs text-white/60 hover:text-white/80 transition-colors duration-200 cursor-pointer select-none" onClick={() => setRememberMe(!rememberMe)}>
                        Remember me
                      </span>
                    </div>
                    
                    <Link href="/forgot-password" title="Forgot Password" className="text-xs text-white/60 hover:text-white transition-colors duration-200">
                      Forgot password?
                    </Link>
                  </div>
