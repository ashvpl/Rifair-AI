...
export function Banner({
  ...
  return (
    <div
      ...
      {...props}
      className={cn(
        "relative z-40 flex flex-row items-center justify-center px-4 text-center text-sm font-medium transition-all duration-500",
        variant === "normal" && "bg-secondary/10",
        ...
        <button
          ...
          className={cn(
            buttonVariants({
              variant: "ghost",
              className:
                "absolute cursor-pointer end-2 md:end-4 top-1/2 -translate-y-1/2 text-muted-foreground/30 hover:text-muted-foreground/60 transition-colors",
              size: "icon",
            }),
          )}
        >
