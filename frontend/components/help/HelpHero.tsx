...
export const HelpHero = () => {
  return (
    <section className="relative pt-14 sm:pt-24 pb-8 sm:pb-16 px-4 sm:px-6 overflow-hidden">
      {/* Background elements */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-4 sm:space-y-8">
        ...
        >
          <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold tracking-tight text-balance">
            How can we help?
          </h1>
          <p className="text-sm sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
