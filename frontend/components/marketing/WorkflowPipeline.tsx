...
const steps = [
  {
    ...
    desc: "Clarify role requirements, skills, responsibilities, and inclusive language.",
  ...
  },
  {
    num: "02",
    label: "Interview Kit",
    desc: "Generate structured, role-specific questions with evaluation rubrics.",
  ...
  },
  {
    ...
    desc: "Evaluate every candidate using consistent scoring criteria.",
  ...
  },
  {
    num: "04",
    label: "Bias Review",
    desc: "Detect biased, vague, or leading questions before interviews begin.",
  ...
  },
  {
    ...
    desc: "Compare candidates using structured evidence, not scattered opinions.",
    href: "/dashboard",
    color: "#1D1D1F",
    bg: "bg-[#F5F5F7]",
    accent: "text-[#1D1D1F]",
