    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#020617] relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="mb-8 text-center">
            ...
            <p className="text-slate-400">Continue your journey to bias-free hiring</p>
        </div>

        <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-1 border border-white/10 shadow-2xl overflow-hidden">
            <SignIn 
                appearance={{
                    elements: {
                        rootBox: "w-full",
